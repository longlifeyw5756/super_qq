...
import com.sxt.superqq.adapter.ExpressionAdapter;
import com.sxt.superqq.adapter.ExpressionPagerAdapter;
import com.sxt.superqq.adapter.MessageAdapter;
import com.sxt.superqq.adapter.VoicePlayClickListener;
...
import com.sxt.superqq.utils.SmileUtils;
import com.sxt.superqq.widget.ExpandGridView;
import com.sxt.superqq.widget.PasteEditText;
...
public class ChatActivity extends BaseActivity implements OnClickListener,
	...
	private void setListener() {
		...
		setEtSendMsgOnFocusChangeListener();
		setEtSendMsgOnClickListener();
		setEtSendMsgAddTextChangedListener();
		setShowEmotionClickListener();
		setHideEmotionClickListener();
		setSendMsgClickListener();
		setTakePictureClickListener();
	}
		...
		findViewById(R.id.btn_picture).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				cameraFile = new File(PathUtil.getInstance().getImagePath(),
					SuperQQApplication.getInstance().getUserName()
	 ...
	 * 设置发送消息按钮的单击事件监听
	 */
	private void setSendMsgClickListener() {
	 ...
	 * 设置隐藏表情列表控件的单击事件监听
	 */
	private void setHideEmotionClickListener() {
	 ...
	 * 设置显示表情控件的单击事件监听
	 */
	private void setShowEmotionClickListener() {
	...
	/**监听文字框*/
	private void setEtSendMsgAddTextChangedListener() {
	 ...
	 * 设置发送聊天消息编辑框的单击事件监听
	 */
	private void setEtSendMsgOnClickListener() {
	...
	/**
	 * 设置发送聊天消息编辑框的焦点改变事件监听
	 */
	private void setEtSendMsgOnFocusChangeListener() {
	...
	public void emptyHistory(View view) {
		...
		startActivityForResult(
				new Intent(this, AlertDialogActivity.class)
				...
				try {
					...
					if (buttonSetModeKeyboard.getVisibility() != View.VISIBLE) {
						...
						if (filename != "delete_expression") { // 不是删除键，显示表情
							...
							mEditTextContent.setText(EmotionUtils.replace(
