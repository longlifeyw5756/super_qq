...
import com.sxt.superqq.adapter.NewFriendsMsgAdapter;
...
public class NewFriendsMsgActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SuperQQApplication.getInstance().getContact_List().get(Constant.NEW_FRIENDS_USERNAME).setUnreadMsgCount(0);
